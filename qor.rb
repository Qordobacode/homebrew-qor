class Qor < Formula
   ...
   url "https://github.com/Qordobacode/Cli-v2/archive/v0.8.1-alpha.tar.gz"
   ...
   def install
     ...
     src.cd do
       system "go", "build", "-mod", "vendor", "-ldflags", "\"-w -s -X 'github.com/qordobacode/cli-v2/cmd/info.VersionFlag=0.8.1-alpha'\"", "-o", "#{bin}/qor"
